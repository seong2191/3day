...
public class MemberVO {
	...
	@NotBlank(message = "id 필수", groups = {Step2.class})
	private String memId; /* 회원 아이디 */
	
	@NotBlank(message = "pw 필수", groups = {Step2.class})
	//@Pattern(regexp = "비밀번호")
	private String memPass; /* 회원 비밀번호 */
	
	@NotBlank(message = "이름 필수", groups = {Step2.class})
	private String memName; /* 회원 이름 */
	
	@NotBlank(message = "email 필수", groups = {Step2.class})
	@Email(message = "email형식이 아닙니다.", groups = {Step2.class})
	private String memMail; /* 이메일 */
	
	@NotBlank(message = "생일 필수", groups = {Step3.class})
	private String memBir; /* 회원 생일 */
	
	@NotBlank(message = "우편번호 필수", groups = {Step3.class})
	private String memZip; /* 우편번호 */
	
	@NotBlank(message = "주소 필수", groups = {Step3.class})
	private String memAdd1; /* 주소 */
	
	@NotBlank(message = "상세주소 필수", groups = {Step3.class})
	private String memAdd2; /* 상세주소 */
	
	
	@NotBlank(message = "연락처 필수", groups = {Step3.class})
	private String memHp; /* 연락처 */
	
	@NotBlank(message = "직업 필수", groups = {Step3.class})
	private String memJob; /* 직업 코드 */
	
	@NotBlank(message = "취미 필수", groups = {Step3.class})
