...
public class ProductList {
	...
	static{		
		...
		vo = new ProdVO("CPU001", "AMD 라이젠 5 3500 (마티스)", "CPU", 140200, "", "/resources/images/prod/CPU001.jpg" , "2019.11.01");
		...
		vo = new ProdVO("CPU002", "인텔 코어i7-9세대 9700K", "CPU", 420000, "", "/resources/images/prod/CPU002.jpg" , "2018.10.01");
		...
		vo = new ProdVO("CPU003", "A인텔 코어i5-9세대 9600KF", "CPU", 203000, "", "/resources/images/prod/CPU003.jpg" , "2019.03.01");
		vo.setProdDetail("진정한 멀티코어로<br>쾌적한 게임과 스트리밍 진행<br>9세대 인텔코어 i5-9600KF 프로세서는 6코어 6스레드로 효과적인 작업이 가능합니다.");
		productMap.put(vo.getProdId(), vo );

		vo = new ProdVO("CPU004", "AMD 라이젠5-3세대 3600XT (마티스)", "CPU", 318290, "", "/resources/images/prod/CPU004.jpg", "2020.07.01");		
		...
		productMap.put("MEM001", new ProdVO("MEM001", "삼성전자 DDR4 8G PC4-21300", "MEM", 40000, 
				                           ...
				                           , "/resources/images/prod/MEM001.jpg" , "2018.03.01") );
		productMap.put("MEM002", new ProdVO("MEM002", "GeIL DDR4 8G PC4-21300 CL19 PRISTINE", "MEM", 34500, 
				                           ...
				                           , "/resources/images/prod/MEM002.jpg" , "2018.05.01") );
		productMap.put("MEM003", new ProdVO("MEM003", "ESSENCORE KLEVV DDR4 8G PC4-21300 CL19", "MEM", 35000, 
				                             ...
				                             , "/resources/images/prod/MEM003.jpg" , "2019.08.01") );
