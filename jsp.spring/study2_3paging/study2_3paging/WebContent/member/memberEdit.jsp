			...
			<tr>
				...
				<td>
					...
					<select name="memJob" class="form-control input-sm" >
						...
						<option value="${job.commCd }" ${memberL.memJob eq job.commCd ? "selected='selected'" : "" }>${job.commNm }</option>
						</c:forEach>
			...
			<tr>
				...
				<td>
					...
					<select name="memHobby" class="form-control input-sm" >
						...
						<option value="${hobby.commCd }" ${memberL.memHobby eq jobby.commCd ? "selected='selected'" : "" }>${hobby.commNm }</option>
						</c:forEach>
