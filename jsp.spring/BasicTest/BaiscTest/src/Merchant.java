...
public class Merchant {
	...
	private int money; // 상인이 가지고 있는 돈
	private int appleCount; // 상인이 가지고 있는 사과개수
	private int applePrice; // 사과 한개당 가격
	...
	// 생성자입니다. 생성자의 선언부는 고치지말고 실행부만 수정해서 BT4의 메인메소드에서 출력값이 10000, 10, 2000 이 나오도록
	// 하세요.
	...
	public void sellApple(int count) {
			...
			this.money += count * this.getApplePrice(); 
