...
//		merchant.applePrice=1000;
		...
		merchant.setMoney(10000);
		merchant.setAppleCount(10);
		merchant.setApplePrice(1000);
		System.out.println(merchant.getMoney());
		System.out.println(merchant.getAppleCount());
		System.out.println(merchant.getApplePrice());
