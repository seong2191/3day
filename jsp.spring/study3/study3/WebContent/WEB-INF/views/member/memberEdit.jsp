							...
							<td><select name="memJob" class="form-control input-sm">
									...
									<c:forEach items="${jobList }" var="job">
										<option value="${job.commCd }"
											${memberL.memJob eq job.commCd ? "selected='selected'" : "" }>${job.commNm }</option>
									</c:forEach>
							...
							<td><select name="memHobby" class="form-control input-sm">
									...
									<c:forEach items="${hobbyList }" var="hobby">
										<option value="${hobby.commCd }"
											${memberL.memHobby eq jobby.commCd ? "selected='selected'" : "" }>${hobby.commNm }</option>
									</c:forEach>
