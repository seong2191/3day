			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-expanded="false">
						<%-- <%=user.getUserName()%> --%>${USER_INFO.userName }님 <span class="caret"></span>
				</a>
					<ul class="dropdown-menu" role="menu">
						<li><a href="<%=request.getContextPath()%>/mypage/info.wow"> <span class="glyphicon glyphicon-home"
								aria-hidden="true"></span> &nbsp;&nbsp;My page
						</a></li>
						...
						<li class="divider"></li>
						<li><a href="<%=request.getContextPath()%>/login/logout.wow"> <span class="glyphicon glyphicon-remove"
